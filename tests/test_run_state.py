...
from .utils.hitl import make_model_and_agent, run_and_resume_with_mutation
...
async def test_resume_rejected_function_approval_emits_output() -> None:
    ...
    assert any(
        isinstance(item, ToolCallOutputItem) and item.output == "Tool execution was not approved."
