...
async def test_execute_tools_handles_tool_approval_item():
    ...
    assert_single_approval_interruption(result, tool_name="test_tool")
...
async def test_execute_tools_handles_shell_tool_approval_item():
    ...
    assert_single_approval_interruption(result, tool_name="shell")
...
async def test_execute_tools_handles_apply_patch_tool_approval_item():
    ...
    assert_single_approval_interruption(result, tool_name="apply_patch")
